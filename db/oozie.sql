...
LOCK TABLES `BUNDLE_ACTIONS` WRITE;
...
LOCK TABLES `COORD_ACTIONS` WRITE;
...
LOCK TABLES `OOZIE_SYS` WRITE;
/*!40000 ALTER TABLE `OOZIE_SYS` DISABLE KEYS */;
INSERT INTO `OOZIE_SYS` VALUES ('db.version','3'),('oozie.version','4.1.0-cdh5.5.0');
...
LOCK TABLES `SLA_REGISTRATION` WRITE;
...
LOCK TABLES `VALIDATE_CONN` WRITE;
...
-- Dump completed on 2017-08-07  7:51:49
